...
export default function Home() {
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-purple-700">
        <div className="p-10 bg-white rounded-lg shadow-2xl max-w-lg">
          ...
          <form action={shortenUrl} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full mt-2">Shorten</button>
